...
export class Backend implements backendInterface {
    ...
    async getAllSections(): Promise<Array<SectionSummary>> {
    ...
    async searchSections(arg0: string): Promise<Array<SearchResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchSections(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
